...
export const Route = createFileRoute("/_auth/ai")({
  ...
  head: () =>
    buildSeoHead({
      title: "AI Playground | Turborepo Boilerplate",
      description:
        "Experiment with the built-in AI chat interface powered by the Turborepo boilerplate stack.",
      path: "/ai",
      keywords: [
        "ai chat playground",
        "generative ai demo",
        "turborepo ai starter",
      ],
      noIndex: true,
    }),
});
