...
const data = await auth.api.createOrganization({
    body: {
        ...
        slug: my-org,
        metadata, // optional
        keepCurrentActiveOrganization: false, // optional
    },
...
We want only pro subscribers to be able to create organizations. To restrict this, set the `allowUserToCreateOrganization` option to a function that returns a boolean.
...
1. **Modern organizationHooks** (recommended) - provides comprehensive control over all organization-related activities
